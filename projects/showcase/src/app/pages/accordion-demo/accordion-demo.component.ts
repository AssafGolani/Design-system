  ...
  template: `
    <section class="space-y-8">
      <div>
        ...
        <p class="mt-2 text-muted-foreground">A vertically stacked set of interactive headings that each reveal a section of content.</p>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div brnAccordion hlmAccordion class="w-full max-w-lg">
          ...
          <div brnAccordionItem hlmAccordionItem>
            ...
            <div brnAccordionContent hlmAccordionContent>
              <div class="pb-4 pt-0">
                Yes. Accordion items can contain any content including form elements, images, and nested components.
              </div>
            </div>
          </div>
        </div>
